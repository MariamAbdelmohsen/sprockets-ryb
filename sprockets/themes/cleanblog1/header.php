...
<html lang="en">
  ...
  <head>
    ...
    <link href="<?=$config->theme_virtual?>vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="index.php">Sprockets</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="post.php">Row Yr Boat</a>
            </li>
            <li class="nav-item">
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('images/<?=$config->headerImage?>')">
